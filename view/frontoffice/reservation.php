    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="service.php" class="nav-item nav-link ">Nos Véhicules</a>
                <a href="reservation.php" class="nav-item nav-link active"></a>

                <a href="contact.html" class="nav-item nav-link">Contact</a>
            </div>
            <a href="" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Réservation<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
...
<div class="container my-5">
    <div class="card border-0 shadow-lg rounded-4" style="background-color: #fff5f5;">
        <div class="card-header bg-danger text-white rounded-top-4 py-3">
            <h4 class="mb-0 text-center">
                <i class="fas fa-calendar-plus me-2"></i>Réserver la voiture
            </h4>
        </div>
        <div class="card-body px-5">
            ...
            <?php endif; ?>
            <form method="POST" id="reservationForm" novalidate><div class="mb-3">
    <label for="id_voiture" class="form-label">Choisir une voiture</label>
    <select class="form-select" name="id_voiture" id="id_voiture" required>
    ...
    <div class="text-danger small mt-1" id="error_voiture"></div>
</div>
...
const errorVoiture = document.getElementById("error_voiture");
errorVoiture.textContent = "";

if (!voiture.value) {
    errorVoiture.textContent = "Veuillez choisir une voiture.";
    valid = false;
}
