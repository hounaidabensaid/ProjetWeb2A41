...
class Reclamation {
    ...
    private $statut;
    private $email; // Nouvelle propriété

    public function __construct($type, $nom_chauffeur, $email,$date_trajet, $sujet, $description, $gravite, $piece_jointe = null, $statut = 'nouveau') {
        $this->type = $type;
        ...
        $this->statut = $statut;
                $this->email = $email; // Initialisation
